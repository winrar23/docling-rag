...
- Документация разбросана по PDF, DOCX, Confluence — сложно искать
- Обычный `grep` не находит смысловые синонимы
- Нужен быстрый локальный инструмент без внешних сервисов и подписок
